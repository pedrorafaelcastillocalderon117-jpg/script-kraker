#!/bin/bash
 ...
 clear
 msg -bar
 rm -rf /etc/Kraker-VPS/demo-ssh 2>/dev/null
 mkdir /etc/Kraker-VPS/demo-ssh 2>/dev/null
 ...
 rm -rf /tmp/cmd
 touch /etc/Kraker-VPS/demo-ssh/$name
 echo "senha: $pass" >> /etc/Kraker-VPS/demo-ssh/$name
 echo "data: ($tmp)Minutos" >> /etc/Kraker-VPS/demo-ssh/$name
 msg -bar2
 echo -e "\033[1;93m ¡¡ USUARIO TEMPORAL x MINUTOS (Kraker-VPS By @Kalix1) !!\033[0m"
 msg -bar2
