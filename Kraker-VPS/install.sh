 ...
 echo -e " \e[97m\033[1;41m   =====>>►►  SCRIPT MOD KRAKER VPS  ◄◄<<=====      \033[1;37m" 
 ...
 msg -ama "     [ SCRIPT \033[1;97m MOD KRAKER VPS\033[1;33m ]" 
 ...
 echo 'figlet ":Kraker VPS:"|lolcat' >> .bashrc 

 echo 'mess1="$(less /etc/Kraker-VPS/message.txt)" ' >> .bashrc 
 ...
 *)ARQ="${SCPfrm}/";; #Herramientas 
 ...
 echo "${nombr}" > /etc/Kraker-VPS/controlador/nombre.log 

 echo -e "\033[1;93mIgrese su ID 👤:\033[0;37m"; read -p " " idbot 

 echo "${idbot}" > /etc/Kraker-VPS/controlador/IDT.log 
 ...
 ipt=`less /etc/Kraker-VPS/IP.log` > /dev/null 2>&1 

 Nip="$(echo $ipt)" 

 NOM="$(less /etc/Kraker-VPS/controlador/nombre.log)" 

 NOM1="$(echo $NOM)" 

 IDB1=`less /etc/Kraker-VPS/controlador/IDT.log` > /dev/null 2>&1 
